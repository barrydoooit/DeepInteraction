...
# Base paths
project_root="/DeepInteraction"
nuscenes_cc_root="${project_root}/data/nuScenes-CC"
nuscenes_cl_root="${project_root}/data/nuScenes-CL"
nuscenes_target_root="${project_root}/data/nuscenes/samples"
